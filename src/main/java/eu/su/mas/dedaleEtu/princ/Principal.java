...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        if (ConfigurationFile.COMPUTERisMAIN) {
            // We should create the Platform and the GateKeeper, whether the platform is
            // distributed or not
            ...
            // 1') If a distant platform already exists, and you want to create and connect
        ...
        // 3) launch agents (until this point, no behaviour for these agents is started
        // yet)
    ...
    private void addOneContainer(Runtime rt, String containerName) {
        ProfileImpl pContainer = new ProfileImpl(ConfigurationFile.PLATFORM_HOSTNAME, ConfigurationFile.PLATFORM_PORT,
    ...
    /**
     * @param containerName name of the container as it will appear in the JADE
     *                      platform
     * @param host          is the IP of the host where the main-container should be
     *                      listened to. A null value means use the default (i.e.
     *                      localhost)
    ...
    private List<AgentController> createAgents() {
        ...
        if (ConfigurationFile.COMPUTERisMAIN) {
            ...
            try {
                Object[] objtab = new Object[] { ConfigurationFile.ENVIRONMENT_TYPE, ConfigurationFile.GENERATOR_TYPE,
                        ...
                        ConfigurationFile.GENERATOR_PARAMETERS };// used to give informations to the agent
                // Object[] objtab=new
                // Object[]{null,null,ConfigurationFile.ENVIRONMENT_TYPE};//used to give
                // informations to the agent
        ...
        // containers
        // They will have to find the gatekeeper's container to deploy themselves in the
        // environment.
        // This is automatically performed by every agent that extends
        // AbstractDedaleAgent

        // ADD YOUR AGENTS HERE - As many as you want.
        // Any agent added here should have its associated configuration available in
        // the entities file
        // or otherwise its behaviour won't be started.
        // The platform will not work unless all agents defined in the entities file are
        // bound by name
        ...
        AgentController[] agentsToAdd = new AgentController[] {
                ...
                newAgent("SituatedAgent04", new String[] {},
                        eu.su.mas.dedaleEtu.sid.grupo03.SituatedAgent03.class),
                newAgent("SituatedAgent05", new String[] {},
                        eu.su.mas.dedaleEtu.sid.grupo03.SituatedAgent03.class)
        };
        ...
        try {
            ...
            AgentController nonDedaleAgent3 = containerList.get(ConfigurationFile.LOCAL_CONTAINER_NAME_MGMT)
                    .createNewAgent(
                            "BDIAgent05", BDIAgent03.class.getName(), new Object[] {});
